 ...
 *   LOCAL_COMFY_PORT (8188) — PC ComfyUI
 *   SALAD_COMFY_PORT (8888) — Salad container listen + Container Gateway
 */
import "./load-env.js";

/** Local ComfyUI listen port / URL. */
export const LOCAL_COMFY_PORT = 8188;
export const LOCAL_COMFY_URL = `http://127.0.0.1:${LOCAL_COMFY_PORT}`;

/**
 * Salad image + Container Gateway port.
 * Dockerfile, entrypoint, salad-deploy probes, and portal Gateway MUST all use this.
 */
export const SALAD_COMFY_PORT = 8888;
