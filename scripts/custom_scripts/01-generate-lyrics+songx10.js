 ...
 *
 * Output:
 *   scripts/custom_scripts/batches/nursery/<song_slug>.mp3
 *   scripts/custom_scripts/batches/nursery/<song_slug>_lyrics.txt
 *   scripts/custom_scripts/batches/nursery/manifest_<timestamp>.json
 *
 * Run:
 *   node scripts/custom_scripts/01-generate-lyrics+songx10.js
 *
 * Optional:
...
const NURSERY_DIR = join(SCRIPT_DIR, "batches", "nursery");
